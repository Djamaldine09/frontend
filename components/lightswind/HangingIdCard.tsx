            ...
            <div className="flex flex-col h-full">
              ...
              >
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white/20 backdrop-blur-sm mt-1 shadow-inner">
                  <img
                    src="https://tse4.mm.bing.net/th/id/OIP.Jiv0yAzavZJlaXQc3vVuZgHaE7?rs=1&pid=ImgDetMain&o=7&rm=3"
                    alt="logo"
              ...
              <div className="bg-white dark:bg-zinc-900 px-4 py-4 flex flex-col items-center gap-2 flex-1">
                ...
                {/* Status badge */}
                <div
                  className="mt-2 px-9 py-8 rounded-full text-[9px] font-bold text-white uppercase tracking-widest"
                  style={{ background: accentColor }}
                >
                  ACTIVE
                </div>
