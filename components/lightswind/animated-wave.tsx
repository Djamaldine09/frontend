...
// Helper function for easing Euler rotation
const addEaseEuler = (
      ...
      moveNoise: function (mouse: { x: number; y: number }) {
        ...
        for (let i = 0; i < positions.count; i++) {
          ...
          if (mouseInteraction && this.mouseDistortionStrength > 0) {
            ...
            // Mix in distortionTime by slightly modifying one of the coordinates
            const mouseRippleNoise = this.simplex(
              distX_mouse / this.mouseDistortionSmoothness + this.distortionTime * 0.1, // Smoothness of the mouse ripple
              distY_mouse / this.mouseDistortionSmoothness // Y coordinate for ripple spread
